...
// HashML-DSA.Sign
//
// Given a 32 -bytes seed `rnd` and ML-DSA-65 secret key, this routine can be used for signing the pre-hash of any
...
// mu = H(tr || M') and signs, producing a ML-DSA-65 signature S. This is FIPS 204 Algorithm 7.
[[nodiscard]] constexpr bool
...
//
// Given a ML-DSA-65 public key, a variable-length message M' and a signature S, this routine verifies
