...
// ML-DSA.Sign_core
//
// Given a 32 -bytes seed `rnd`, ML-DSA-44 secret key and 64 -bytes message representative mu, this routine
// produces a ML-DSA-44 signature S. The caller is responsible for computing mu.
[[nodiscard]] constexpr bool
...
// ML-DSA.Verify_core
//
// Given a ML-DSA-44 public key, 64 -bytes message representative mu and a signature S, this routine verifies
