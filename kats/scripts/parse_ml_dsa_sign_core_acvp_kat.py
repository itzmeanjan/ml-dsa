...
ML_DSA_44_ACVP_KAT_FILE_NAME="ml_dsa_44_sign_core.acvp.kat"
ML_DSA_65_ACVP_KAT_FILE_NAME="ml_dsa_65_sign_core.acvp.kat"
ML_DSA_87_ACVP_KAT_FILE_NAME="ml_dsa_87_sign_core.acvp.kat"

def extract_and_write_ml_dsa_sign_core_kats(test_groups: list[dict[str, typing.Any]], write_to_file: str):
...
def main():
    ...
    extract_and_write_ml_dsa_sign_core_kats(ml_dsa_44_param_set, ML_DSA_44_ACVP_KAT_FILE_NAME)
    extract_and_write_ml_dsa_sign_core_kats(ml_dsa_65_param_set, ML_DSA_65_ACVP_KAT_FILE_NAME)
    extract_and_write_ml_dsa_sign_core_kats(ml_dsa_87_param_set, ML_DSA_87_ACVP_KAT_FILE_NAME)
