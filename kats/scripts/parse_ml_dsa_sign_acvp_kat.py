...
ML_DSA_44_ACVP_KAT_FILE_NAME="ml_dsa_44_sign.acvp.kat"
ML_DSA_65_ACVP_KAT_FILE_NAME="ml_dsa_65_sign.acvp.kat"
ML_DSA_87_ACVP_KAT_FILE_NAME="ml_dsa_87_sign.acvp.kat"
...
def extract_and_write_ml_dsa_sign_kats(test_groups: list[dict[str, typing.Any]], write_to_file: str):
    with open(write_to_file, "wt") as fd:
        for test_group in test_groups:
            ...
            assert test_group["preHash"] == "pure"
...
def main():
    ...
    ml_dsa_44_param_set = [acvp_kats["testGroups"][0], acvp_kats["testGroups"][12]]
    ml_dsa_65_param_set = [acvp_kats["testGroups"][2], acvp_kats["testGroups"][14]]
    ml_dsa_87_param_set = [acvp_kats["testGroups"][4], acvp_kats["testGroups"][16]]
