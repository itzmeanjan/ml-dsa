...
PASSED TESTS (22/22):
   ...
   32317 ms: build/test/test.out ML_DSA.ML_DSA_87_KeygenSignVerifyFlow
```
...
See example [program](./examples/ml_dsa_44.cpp), which demonstrates how to use ML-DSA-44 API, similarly you can use ML-DSA-{65, 87} API. Run the example by issuing
