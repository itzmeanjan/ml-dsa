...
void
test_ml_dsa_65_signing(const size_t mlen, const size_t ctx_len, auto sign_fn, auto verify_fn)
{
  assert(ctx_len < 256);
  ...
  ml_dsa_65::keygen(seed, pkey, skey);
...
// Test HashML-DSA sign/verify for ML-DSA-65 across all SHA3-family hash algorithms.
TEST(ML_DSA, ML_DSA_65_HashSignVerifyFlow)
{
  ...
  test_with_hash([](auto&... args) { return ml_dsa_65::hash_sign<ha::SHA3_256>(args...); }, [](auto&... args) { return ml_dsa_65::hash_verify<ha::SHA3_256>(args...); });
  test_with_hash([](auto&... args) { return ml_dsa_65::hash_sign<ha::SHA3_384>(args...); }, [](auto&... args) { return ml_dsa_65::hash_verify<ha::SHA3_384>(args...); });
  test_with_hash([](auto&... args) { return ml_dsa_65::hash_sign<ha::SHA3_512>(args...); }, [](auto&... args) { return ml_dsa_65::hash_verify<ha::SHA3_512>(args...); });
  test_with_hash([](auto&... args) { return ml_dsa_65::hash_sign<ha::SHAKE_128>(args...); }, [](auto&... args) { return ml_dsa_65::hash_verify<ha::SHAKE_128>(args...); });
  test_with_hash([](auto&... args) { return ml_dsa_65::hash_sign<ha::SHAKE_256>(args...); }, [](auto&... args) { return ml_dsa_65::hash_verify<ha::SHAKE_256>(args...); });
}
